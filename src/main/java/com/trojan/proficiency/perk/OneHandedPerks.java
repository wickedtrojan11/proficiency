...
public final class OneHandedPerks {
    ...
    public static final SkillPerk OFFHAND_STRIKE = perk("offhand_strike", "Offhand Strike", "Your second weapon is always ready.", "Dual-wield effects reserved for a future update.", 5, 125, 325, null);
    ...
    public static final SkillPerk DUELISTS_FOCUS = perk("duelists_focus", "Duelist's Focus", "A lone weapon leaves no room for wasted motion.", "Duelist effects reserved for a future update.", 5, 220, 325, null);
    public static final SkillPerk PARRY = perk("parry", "Parry", "Timing turns an enemy's strength aside.", "Parry effects reserved for a future update.", 12, 220, 265, "duelists_focus");
    ...
    public static final SkillPerk SHIELD_TRAINING = perk("shield_training", "Shield Training", "Weapon and shield move in practiced balance.", "Shield effects reserved for a future update.", 5, 315, 325, null);
    ...
    public static final SkillPerk BLADE_TRAINING = perk("blade_training", "Blade Training", "Every one-handed weapon teaches the same fundamentals.", "Mastery effects reserved for a future update.", 5, 410, 325, null);
